...
namespace SIGEBI.Views.GestionBibliografica
{
    public partial class EditarDocumentoDialog : Window
    {
        ...
        public EditarDocumentoDialog(RecursoDetalleDTO recurso) : this(
            recurso,
        ...
        public EditarDocumentoDialog(RecursoDetalleDTO recurso, ResourceUploadService api, ICategoriasApi categoriasApi, IRecursosApi recursosApi)
        {
            InitializeComponent();
            _recurso = recurso;
            _api = api;
