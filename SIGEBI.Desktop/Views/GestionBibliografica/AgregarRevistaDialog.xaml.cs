...
namespace SIGEBI.Views.GestionBibliografica
{
    public partial class AgregarRevistaDialog : Window
    {
        ...
        public AgregarRevistaDialog() : this((ResourceUploadService)SIGEBI.App.Current.Services.GetService(typeof(ResourceUploadService))!, (ISigebiApi)SIGEBI.App.Current.Services.GetService(typeof(ISigebiApi))!) { }

        public AgregarRevistaDialog(ResourceUploadService api, ISigebiApi sigebiApi)
        {
            InitializeComponent();
            _api = api;
