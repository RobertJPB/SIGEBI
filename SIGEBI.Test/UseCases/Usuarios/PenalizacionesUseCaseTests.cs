...
namespace SIGEBI.Test.UseCases.Usuarios
{
    public class PenalizacionesUseCaseTests
    {
        ...
        {
            // Arrange
            var prestamo = new Prestamo(Guid.NewGuid(), Guid.NewGuid(), 7, DateTime.UtcNow.AddDays(-10));
        ...
        public async Task AplicarPenalizacionManual_DatosValidos_CreaYGuarda()
        {
            ...
            var usuario = new SIGEBI.Domain.Entities.Usuario("T", "t@t.com", "h", SIGEBI.Domain.Enums.Seguridad.RolUsuario.Estudiante);
        ...
        {
            // Arrange
            var penalizacion = new Penalizacion(Guid.NewGuid(), "M", 3, DateTime.UtcNow);
